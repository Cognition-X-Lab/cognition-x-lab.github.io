...
o	Task/Objective (link to issue/ticket)
o	Context/Notes (what was tried, references)
o	Outcome/Result (metrics, artifacts) with date 
o	Next Action(s) with owner and due date
o	Blockers/Risks
o	Links (PRs, commits, notebooks, data)
...
o	Publications: Target venues and tentative titles.
o	Awards/Fellowships: Targets and deadlines.
o	Teaching/TA/Service: Planned roles and outcomes.
o	Conferences/Talks/Posters: Target talks and conferences.
o	Industry/Agency Engagement: Collaborations, internships, pilots, policy briefs.
